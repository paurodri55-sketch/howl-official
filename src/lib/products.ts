...
export const products: Product[] = [
  ...
  },
  {
    ...
    logoStyle: { tracking: "wide", decoration: "none", accent: "⚙", accentColor: "#c0392b" },
    tourDates: [],
    isNew: true,
  },
  {
  ...
  {
    id: "p52",
    slug: "bandiera-minimale",
    name: "Bandiera Minimale",
    band: "HOWL",
    tourYear: "",
    editionLabel: "Colección",
    price: 25.9,
    ...
    reviewCount: 2,
    description:
      "Camiseta de la colección Italiana. Bandera de Italia en miniatura al pecho, justo encima del wordmark HOWL — sofisticada y minimalista.",
    details: lifestyleDetails,
    category: "Camisetas",
    sizes: tourTeeSizes,
    colors: [agedCream],
    graphic: "landscape",
    artworkImage: "/artwork/bandiera_chest.png",
    frontLogoOnly: true,
    skipModelPhotos: true,
    logoStyle: { tracking: "wide", decoration: "none", accent: "🇮🇹", accentColor: "#ce2b37" },
    tourDates: [],
    isNew: true,
  },
  {
